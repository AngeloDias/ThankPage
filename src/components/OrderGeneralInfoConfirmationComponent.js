...
export default function OrderGeneralInfoConfirmationComponent() {
    return(
        <div className="section order-message">
            <div className="container">
                ...
                <div className="row center">
                    <a href="#3" className="btn-large waves-effect waves-light black round-button">View the dog's health details</a>
                </div>
